...
/**
 * Exponentiation of one expression to the other
 * @param <E> The type of numbers used in this expression
 */
public class PowerExpression<E extends Number> extends BinaryExpression<E>
{
	/**
	 * Valued consrtructor
	 ...
	 */
	public PowerExpression(Expression<E> left,
	                       Expression<E> right)
	{
		super(left, right, BinaryOperatorRules.POWER);
	}
	...
	{
		/*
		 * TODO Update to match power operations
		 */
		...
		{
			return (E) Float.valueOf((float)Math.pow(value1.intValue(), value2.intValue()));
		}
		if (value1 instanceof Double)
		{
			return (E) Double.valueOf((double)Math.pow(value1.intValue(), value2.intValue()));
		}
