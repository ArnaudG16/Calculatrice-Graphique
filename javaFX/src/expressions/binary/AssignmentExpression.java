...
public class AssignmentExpression<E extends Number> extends BinaryExpression<E>
{
	...
	public E value() throws IllegalStateException
	{
		...
		VariableExpression<E> var = (VariableExpression<E>) left;
        var.setValue(right.value());
        return var.value();	}
	...
	{
		// TODO Replace with correct implementation
        return (left != null && right != null && right.hasValue());	}
	...
	{
		if (parent instanceof TerminalExpression<?> || parent instanceof BinaryExpression<?>)
        {
